        ...
        return {
            ...
            computeHelper: ( schema ) =>
            {
                switch ( schema.name )
                {
                    ...
                    case "use_custom_folder_integration":
                        return "EXPERIMENTAL: Use custom folder integration (scan_dir).";
                    case "custom_folder_path":
                        return "The path to the custom folder. Default is /media/photo-frame.";
                }
                return undefined;
            },
